namespace OpenClosePrinciple
{
    public class UserManager : IUserManager
    {
        ...
        public UserManager(IUserService userService, IEmailService emailService, IBlacklistedUser blacklistedUser)
        {
        ...
        {
            bool registeredUser =!_blacklistedUser.CheckUser(aUser) && _userService.RegisterService(aUser);
